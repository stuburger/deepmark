import { assertBatchAccess, requireSessionUser } from "@/lib/authz"
...
export async function GET(
	request: NextRequest,
	{
		...
		params: Promise<{ batchId: string; scriptId: string; pageOrder: string }>
	},
) {
	...
	const batchOk = await assertBatchAccess(session.user, batchId, "viewer")
	if (!batchOk.ok) {
