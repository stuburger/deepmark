...
import { listQuestions, type QuestionListItem } from "@/lib/dashboard-actions"
...
function QuestionRow({ q }: { q: QuestionListItem }) {
	return (
		<TableRow>
			<TableCell>
				<Badge variant={subjectVariant(q.subject)}>{capitalize(q.subject)}</Badge>
			</TableCell>
			...
			<TableCell className="text-center">
				{q.points != null ? q.points : <span className="text-muted-foreground">—</span>}
			</TableCell>
