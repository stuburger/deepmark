...
type Props = {
	...
	debugMode?: boolean
	/** Mark overlays (ticks, crosses, commentary) persisted by the grade Lambda. */
	annotations?: StudentPaperAnnotation[]
	/** Controls mark overlay visibility. */
	showMarks?: boolean
	/** Controls chain indicator highlight visibility. */
	showChains?: boolean
	/** Called when a mark overlay is clicked, with the question ID. */
											...
											annotations
												...
												.map((a) => (
													<AnnotationHitTarget
														key={a.id}
														annotation={a}
														onClick={() => onMarkClick?.(a.question_id)}
													/>
												))}
