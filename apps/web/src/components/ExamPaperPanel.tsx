...
function ExtractedAnswerRow({ answer: a }: { answer: ExtractedAnswer }) {
	return (
		<div className="px-5 py-4 space-y-1.5">
			...
			{a.answer_text ? (
				<p className="text-base leading-relaxed whitespace-pre-wrap text-zinc-800 dark:text-zinc-200 border-l-2 border-zinc-200 dark:border-zinc-700 pl-3">
					{a.answer_text}
				</p>
			) : (
				<p className="text-base italic text-zinc-400 dark:text-zinc-600 border-l-2 border-dashed border-zinc-200 dark:border-zinc-700 pl-3">
					No answer written
				</p>
			)}
		</div>
